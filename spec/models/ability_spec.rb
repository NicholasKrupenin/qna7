...
RSpec.describe Ability do
  ...
  describe 'for user' do
    ...
    context 'select best answer' do
      it { should be_able_to :star, create(:answer, question: question, user_id: other_user.id) }
      it { should_not be_able_to :star, create(:answer, question: other_question, user_id: user.id) }
    end
    ...
    context 'can voted' do
      it { should be_able_to [:vote_like, :vote_dislike, :deselect], other_question }
      it { should_not be_able_to [:vote_like, :vote_dislike, :deselect], question }

      it { should be_able_to [:vote_like, :vote_dislike, :deselect], other_answer }
      it { should_not be_able_to [:vote_like, :vote_dislike, :deselect], answer }
    end
  end
end
